...
] 600, 735 ]:   D = 1.005 * (54 - 0.0333*T_C) / (7850 * (666 + 13002/(738 - T_C))) * 1e6
] 735, 800 ]:   D = 1.005 * (54 - 0.0333*T_C) / (7850 * (545 + 17820/(T_C - 731))) * 1e6
...
] 600, 735 ]:   D = 0.995 * (54 - 0.0333*T_C) / (7850 * (666 + 13002/(738 - T_C))) * 1e6
] 735, 800 ]:   D = 0.995 * (54 - 0.0333*T_C) / (7850 * (545 + 17820/(T_C - 731))) * 1e6
