...
file1_name = r"F:\98_Für Kjell\Vary h on inside\diffusion_array_h_on_the_inside-0.h5"
file2_name = r"F:\98_Für Kjell\Variable Solu acc to sievert.h5"
...
with writer.saving(fig, "diffusion_comparison_animation.mp4", dpi=96):
