...
| P4 | Hydrogen Permeation Flux | Generates normalized 1D permeation-response diagrams for ideal diffusion, changing entry conditions, McNabb-Foster trapping, and aged prefilling. |
