"""Transient area-summary dots paired with the measured x-profile."""

PRESET_NAME = "Transient Area Summary with Concentration Profile"

RENDER_MODE = "area_summary_dots"
FIGURE_SIZE = (13, 6)
MATCH_SIDE_PANEL_HEIGHT_TO_MAIN = False
TITLE = "Transient diffusion: occupancy and concentration profile"
X_LABEL = "Length"
Y_LABEL = "Height"
...
# Reconstruct the saved concentration profile in the dot field, preserving
# transient x-variation instead of reducing each half to one average.
...
AREA_SUMMARY_DOT_LEGEND_LOCATION = "lower right"
AREA_SUMMARY_DOT_LEGEND_ANCHOR = (0.97, 0.03)
...
# Put the measured concentration profile directly on top of the dot field.
# The curve uses the same x-axis as the dots and a right-hand percentage axis.
...
# Use the matching *_continued.h5 file when available. The continuation's
# saved concentration profiles are averaged before the dots and overlay line
# are drawn. Its first frame is the duplicated continuation start state.
