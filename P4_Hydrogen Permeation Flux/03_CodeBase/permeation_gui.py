...
FIELD_GROUPS = [
    ...
    ("McNabb–Foster trapping", [
        ...
        ("trapping.capacity_sweep_binding_energy_kJ_mol", "Capacity-sweep binding energy [kJ/mol]", "float", True),
        ("trapping.release_sweep_capacity_ratio", "Release-sweep capacity", "float", True),
        ("trapping.binding_energy_kJ_mol", "Binding-energy sweep [kJ/mol]", "list_float", False),
        ("trapping.binding_energy_temperature_K", "Binding-energy temperature [K]", "float", True),
        ("trapping.detrapping_prefactor_s_inv", "Detrapping prefactor [1/s]", "float", True),
        ("trapping.lattice_activation_energy_kJ_mol", "Lattice activation energy [kJ/mol]", "float", True),
