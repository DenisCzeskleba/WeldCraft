...
ANALYSIS_PARENT_FOLDER_NAME: str = "Convergence Analysis"  # folder will be created if missing
...
SIMULATION_RUNS_LIST: List[SimulationRunDescription] = [
    ...
    SimulationRunDescription(file_path="run_dx1.00.h5", label_for_plots_and_csv="dx=1.00", spatial_step_dx_mm=1.00),
    SimulationRunDescription(file_path="run_dx0.50.h5", label_for_plots_and_csv="dx=0.50", spatial_step_dx_mm=0.50),
    SimulationRunDescription(file_path="run_dx0.25.h5", label_for_plots_and_csv="dx=0.25", spatial_step_dx_mm=0.25),
]
